...
public enum Config {
    ...
    DEBUG_LOG("Options.Debug.DebugLog", false, "Enables debug logs."),
    DEBUG_FORCE_SQL("Options.Debug.ForceSql", false, "Only enable this if you know what you're doing! This will decrease performance!"),
